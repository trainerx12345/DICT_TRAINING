<?php 
   ...
   ?>
<!-- Section Employees-->
<section class="py-5 vh-100" id="payslip">
  <div class="container">
    <!-- Register Modal -->
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-3 shadow">
          <div class="modal-header bg-primary text-white">
            <h2 class="modal-title">Create a Payslip</h2>
          ...
          <div class="modal-body">
            <form class="g-3 needs-validation" action="./create/create_department.php" method="post">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name" name='name' placeholder='Enter Payslip Name' required>
              </div>
              <div class="mb-3">
                <label for="short_name" class="form-label">Payslip Short Name</label>
                <input type="text" class="form-control" id='short_name' name='short_name'
                  placeholder='Enter Payslip Short Name' required>
              </div>
    ...
    <div id="update_department" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true"
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-3 shadow">
          <div class="modal-header bg-primary text-white">
            <h2 class="modal-title">Update Payslip</h2>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            ...
            <form class="g-3 needs-validation" action="/pages/update/update_department.php" method="post">
              ...
              <div class="col-md-4">
                <label for="name" class="form-label">Payslip Name</label>
                <input type="text" class="form-control" id="d_name" name='d_name' placeholder=' Payslip Name' required>
              </div>
              <div class="col-md-4">
                <label for="short_name" class="form-label">Payslip Short Name</label>
                <input type="text" class="form-control" id='d_short_name' name='d_short_name'
                  placeholder=' Payslip Short Name' required>
              </div>
    ...
    <h2 class="text-center mb-4">List of Payslips</h2>
    <div class="table-responsive">
      <div class='d-flex align-items-center gap-3 my-3'>
        ...
        <div class="d-flex gap-2 flex-fill">
          <h4 class="mb-3">Search Payslips</h4>
